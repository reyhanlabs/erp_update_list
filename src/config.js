...
export const APP_VERSION = '4.21.2';
export const APP_VERSION_DATE = '2026-09-24';
export const APP_VERSION_NOTE = 'Fix notification toggle async syntax error';

export const RFT_STATUS_CACHE_KEY = 'erp_rft_status_id';
export const MIGRATE_SNAP_KEY = 'erp_migrate_snapshot_v1';
export const REDMINE_STORAGE_KEY = 'zahir-redmine-project';
